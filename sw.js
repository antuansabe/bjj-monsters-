// BJJ Monsters · service worker mínimo: shell offline, red primero para el HTML.
const CACHE='bjjm-v1',SHELL=['./','index.html','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
